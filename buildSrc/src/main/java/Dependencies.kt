object Version {
    ...
    const val scalarConverters = "2.1.0"
    ...
    const val viewModelDelegate = "1.7.0"
...
object TestImplementation {
    ...
    const val mockitoKotlin = "com.phaarman.mockitoKotlin2:mockito-kotlin:${Version.mockitoKotlin}"
...
object Retrofit{
    ...
    const val scalarConverters = "com.squareup.retrofit2:converter-scalars:${Version.scalarConverters}"
}
...
object CoroutinesLifecycleScope{
    const val lifecycleViewModel = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Version.coroutineLifecycleScope}"
    const val lifecycleRuntime = "androidx.lifecycle:lifecycle-runtime-ktx:${Version.coroutineLifecycleScope}"
}
...
object Room{
    ...
    const val room = "androidx.room:room-ktx:${Version.daggerHiltAndroidTestImpl}"
}
